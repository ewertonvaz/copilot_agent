...
# Rodar o Copilot example como server uvicorn
```bash
uv run uvicorn sample_agent.demo:app --host 0.0.0.0 --port 8080

ou

uv run uvicorn sample_agent.demo:main --host 0.0.0.0
